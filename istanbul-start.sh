...
PRIVATE_CONFIG=data/constellation/tm.ipc nohup geth --datadir data $ARGS $WEBSOCKET_ARGS --wsorigins "*" --wsport 8546 --unlock 0 --password passwords.txt --rpcport 22000 --port 21000 --istanbul.blockperiod 1 2>>data/logs/quorum.log &
set +v
