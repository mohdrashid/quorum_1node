...
PRIVATE_CONFIG=./data/constellation/tm.ipc nohup geth console --datadir data $ARGS  $WEBSOCKET_ARGS --wsorigins "*" --rpcport $RPC_PORT --wsport $WS_PORT --permissioned --raftport $RAFT_PORT --port $GETH_PORT 2>>$LOG_DIR/quorum.log 
echo
